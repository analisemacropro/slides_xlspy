...
✅ **Cadastro em Dados.gov.br**<br><br>
:::
...
<br>
**Antes de começar o código, faça isso:**

1. Acessar este link: [https://dados.gov.br/auth/minha-conta](https://dados.gov.br/auth/minha-conta)
2. Clicar em "*Entrar com gov.br*"
3. Digitar seu CPF e dados para cadastrar/acessar conta
4. Clicar em *Gerar/Regerar* (Token)
5. Clicar em *Ver* (Token)
6. Copiar o Token gerado e armazenar em local seguro
